...
int stationary_line_collision(const double circle_centre_x, const double circle_centre_y, float radius, float angle, float distance, Point v1, Point v2, float solid_x, float solid_y, PotentialMove& move, int circle_location);
