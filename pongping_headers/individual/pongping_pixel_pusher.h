...
enum { PONGPING_HORIZONTAL_GRADIENT_LIGHT_EDGE_RIGHT, PONGPING_HORIZONTAL_GRADIENT_LIGHT_EDGE_LEFT, 
       PONGPING_VERTICAL_GRADIENT_LIGHT_EDGE_TOP, PONGPING_VERTICAL_GRADIENT_LIGHT_EDGE_BOTTOM };

void make_bitmap_a_gradient(ALLEGRO_BITMAP *bitmap, int x1, int y1, int x2, int y2, int orientation);
