   ...
   public:
     ...
     void set_last_feature_hit() { id_of_last_polygon_hit = -1; }
      ...
      virtual void draw(void) 
	  {
		 ...
		 else if(phase == PONGPING_CIRCLE_COLLECTED_PHASE)
		 {
			...
			//logfile << "calling draw (dying circle).\n";
      ...
      void start_speed_transition(float increment)
      {
         ...
         //logfile << "starting speed transition.\n";
      }
      ...
      void update_increment()
      {
         ...
         //logfile << "added to distance_increment.\n";
	  ...
	  */
	  ...
	  { 
		 ...
		 if(move->pfot > 1.0)
		 {
		    logfile << "\n\napply_move() : pfot greater than 1 . It is " << move->pfot << "\n\n";
		    eek();
		 }
